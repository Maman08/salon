...
const collections = [
  {
    ...
    description: "A complete skincare routine for luminous, radiant skin. Curated from our most-loved salon facials.",
  ...
  },
  {
    ...
    description: "The exact products our stylists use daily. Professional-grade quality, now for your home.",
