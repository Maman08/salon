...
const timeline = [
  {
    title: "The Vision",
    description: "Grenix was born from a deep love of beauty and a desire to make premium-grade products accessible to everyone.",
  },
  {
    title: "The Formula",
...
const values = [
  ...
  },
  {
    ...
    description: "Every customer matters. Your feedback shapes every product we create and curate.",
  },
  {
    icon: Award,
            ...
            <div>
              ...
              <Reveal delay={0.1}>
                <p className="text-[var(--fg-muted)] leading-relaxed mb-4 opacity-60">
                  Grenix was created with a single belief — that
